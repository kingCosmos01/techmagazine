...
<head>
    ...
    <link rel="stylesheet" href="./css/business-nav.css">
        ...
        <div class="wrapper">
            ...
            <div class="navContainer" id="navContainer">
                ...
                <div class="navigations">
                    ...
                    <a href="" id="navBtn"><i class="fa fa-briefcase" aria-hidden="true"></i> Business</a>
                    ...
                    <a href="./forum.php" id="navBtn">Forum</a>
                    <a href="./donate.php" class="donateBtn" id="donateBtn" onclick="payWithPaystack()">Donate</a>
                </div>
            </div>
            <div class="navs">
                <a href="" id="navBtn"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
                <a href="" class="business" id="navBtn"><i class="fa fa-briefcase" aria-hidden="true"></i> Business</a>
                <a href="./fashion.php" id="navBtn">Fashion</a>
                <a href=",.sports.php" id="navBtn">Sports</a>
                <a href="./anime.php" id="navBtn">Anime</a>
